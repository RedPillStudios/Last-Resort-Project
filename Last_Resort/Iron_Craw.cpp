...
update_status Iron_Craw::Update() {
	...
	App->render->Blit(actual, position.x - 9, position.y + 18, &blueCircle.GetCurrentFrame());
	App->render->Blit(actual, position.x + 20, position.y + 18, &blueCircle.GetCurrentFrame());
	App->render->Blit(actual, position.x - 3, position.y + 33, &leg1.GetCurrentFrame());
	App->render->Blit(actual, position.x + 27, position.y + 33, &leg2.GetCurrentFrame());
	App->render->Blit(actual, position.x, position.y, &Current_AnimationBody->GetCurrentFrame());
	App->render->Blit(actual, position.x + 38, RArmPosition, &Right_Arm.GetCurrentFrame());
	App->render->Blit(actual, position.x - 44, LArmPosition, &Left_Arm.GetCurrentFrame());
