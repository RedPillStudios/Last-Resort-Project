...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_PLAYER_SHOT][COLLIDER_POWER_UP] = true;
	...
	matrix[COLLIDER_POWER_UP][COLLIDER_PLAYER_SHOT] = true;
	matrix[COLLIDER_POWER_UP][COLLIDER_PLAYER_SHOT2] = true;
